...
This example dispatches to an API bot under "/api", an admin bot
under "/admin", and an bot that serves frontend files for all other
requests::

    bot = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
